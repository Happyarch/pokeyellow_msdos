...
ELEMENTS = [
    ...
    el("DIALOG_LINE1", "text", 1, 14, 18, 1, text_label="Wild RATTATA",
       ...
       notes="box interior row 2; intro/message line 1; inside=DIALOG_BOX"),
    el("DIALOG_LINE2", "text", 1, 16, 18, 1, text_label="appeared!",
       source="core.asm BTXT_LINE2", pret_ref="home/text.asm (<LINE>)",
       notes="box interior row 4; message line 2; inside=DIALOG_BOX"),
    ...
    el("ACTION_TEXT", "text", 10, 14, 8, 3, text_label="FIGHT\nITEM  RUN",
       ...
       notes="double-spaced 2 lines (rows +0/+2); inside=ACTION_MENU_BOX; "
             "link=action"),
    el("ACTION_CUR_L", "cursor", 9, 14, 1, 1, min_w=1, min_h=1,
       ...
       notes="FIGHT/PKMN column; cursor rows +0/+2; inside=ACTION_MENU_BOX; "
             "link=action"),
    el("ACTION_CUR_R", "cursor", 15, 14, 1, 1, min_w=1, min_h=1,
       ...
       notes="ITEM/RUN column; inside=ACTION_MENU_BOX; link=action"),
    el("SAFARI_TEXT", "text", 2, 14, 16, 3,
       ...
       notes="double-spaced 2 lines (safari replaces the action menu with "
             "full-width labels); inside=DIALOG_BOX"),
    ...
    el("MOVE_CURSOR", "cursor", 5, 13, 1, 1, min_w=1, min_h=1,
       ...
       notes="single-spaced rows +0..+3; inside=MOVE_BOX; link=moves"),
