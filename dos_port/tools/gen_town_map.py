...
def emit_gfx() -> str:
    blobs = [
        ("CompressedMap", "town_map.rle", None),
        ("WorldMapTileGraphics", "town_map.2bpp", "WorldMapTileGraphicsEnd"),
        ("TownMapCursor", "town_map_cursor.1bpp", "TownMapCursorEnd"),
        ("TownMapUpArrow", "up_arrow.1bpp", "TownMapUpArrowEnd"),
        ("MonNestIcon", "mon_nest_icon.1bpp", "MonNestIconEnd"),
    ]
    out = [
