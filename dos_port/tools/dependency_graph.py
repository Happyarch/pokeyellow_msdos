...
STATUSES = {"translated", "relocated", "stub", "missing", "port_only"}
REQUIRED = {
...
def build_graph(con, side, annotations=None):
    ...
    return {"side": side, "nodes": result_nodes, "edges": edges,
            "coverage_note": "Modeled labels/calls only. dd dispatch tables and address-taken targets emit no edge; ISR and jump-table execution is not disproved by their absence. Names-only script_labels and unmodeled audio/data are outside coverage."}
...
JS = r"""
'use strict';
const colors={translated:'#43c879',relocated:'#a873e8',stub:'#e7aa3b',missing:'#e45858',port_only:'#42cad5',unindexed:'#8491a3'};
