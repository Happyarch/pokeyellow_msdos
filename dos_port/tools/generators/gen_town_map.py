...
def emit_data(meta, external, internal, order, names, inline) -> str:
    out = [
        "; town_map_data.inc — generated by tools/generators/gen_town_map.py. DO NOT EDIT BY HAND.",
...
def emit_gfx() -> str:
    ...
    out = [
        "; town_map_gfx.inc — generated by tools/generators/gen_town_map.py. DO NOT EDIT BY HAND.",
        "; Raw town-map graphics blobs (INCBIN equivalents from gfx/town_map/).",
        "; (The Fly screen's bird cursor lives in mon_icons.asm's mon_icons.inc",
        "; and is externed — single definition.)",
        "",
    ]
