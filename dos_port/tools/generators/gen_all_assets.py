...
def write_inc(dst: Path, label: str, data: bytes, comment: str = "",
              export: bool = False):
    lines = [f"; {dst.name} — generated by tools/generators/gen_all_assets.py. DO NOT EDIT BY HAND."]
    if comment:
        lines.append(f"; {comment}")
    if export:
        # The file that DEFINES a label DECLARES it global (gen_globals.py
        # rule). Exported blobs are referenced from a different TU: the
        # overworld tileset triple stays in overworld.asm while the Tileset*
        # dispatch tables that point at it live in src/data/maps/map_headers.asm,
        # and route23/indigo_plateau travel with map_headers.asm while
        # LoadOverworldAssets consumes them from overworld.asm.
        lines += ["", f"global {label}", f"global {label.upper()}_SIZE"]
    lines += ["", f"{label}:"]
...
def generate_sprite_sheet_pointers():
    ...
    lines = [
        "; sprite_sheet_pointers.inc — generated by tools/generators/gen_all_assets.py. DO NOT EDIT BY HAND.",
...
def main():
    ...
    for tid, canonical, gfx_stem, blocks_stem, coll_label in TILESETS:
        ...
        # The overworld triple stays in overworld.asm's TU while the Tileset*
        # dispatch tables that reference it moved to src/data/maps/map_headers.asm
        # — so only it needs its labels/SIZEs exported.
        cross_tu = canonical == "overworld"
        write_inc(
    ...
    table_lines = [
        "; npc_sprite_data_table.inc — generated by tools/generators/gen_all_assets.py. DO NOT EDIT BY HAND.",
