...
Run from the repo root: python3 dos_port/tools/generators/gen_font_battle_extra_inc.py
"""
import sys
...
def main():
    ...
    out = [
        ...
        "; via dos_port/tools/generators/gen_font_battle_extra_inc.py.  DO NOT EDIT BY HAND.",
