...
def main() -> int:
    ...
    pout = [
        ...
        "; The POKéDEX list screen's PlaceString labels (pret engine/menus/pokedex.asm).",
        "; The first four are pret GLOBALs and keep pret's names; the last keeps pret's",
        "; ROUTINE-LOCAL name (Pokedex_PlacePokemonList.dashedLine) via NASM's Global.local",
        "; form. GB-charmap encoded via gb_text.encode (unicode_converter submodule);",
        "; <NEXT> $4E and '@' $50 are raw control bytes. section .data (see link.ld).",
        "",
        "section .data",
        "",
    ]
