; CinnabarMart.asm — translated from pret scripts/CinnabarMart.asm by dos_port/tools/sm83xlat.
;
...
global CinnabarMartScientistText
global CinnabarMartSilphWorkerFText
global CinnabarMart_Script
