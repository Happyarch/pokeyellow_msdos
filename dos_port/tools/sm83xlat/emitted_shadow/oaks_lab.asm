...
%ifndef hNPCPlayerRelativePosPerspective
hNPCPlayerRelativePosPerspective               equ H_NPC_PLAYER_RELATIVE_POS_PERSPECTIVE
%endif
%ifndef hNPCPlayerYDistance
hNPCPlayerYDistance                            equ H_NPC_PLAYER_Y_DISTANCE
%endif
%ifndef wNPCMovementDirections
wNPCMovementDirections                         equ W_NPC_MOVEMENT_DIRECTIONS
%endif
%ifndef wNPCMovementScriptFunctionNum
wNPCMovementScriptFunctionNum                  equ W_NPC_MOVEMENT_SCRIPT_FUNCTION_NUM
%endif
%ifndef wNPCNumScriptedSteps
wNPCNumScriptedSteps                           equ W_NPC_NUM_SCRIPTED_STEPS
%endif
%ifndef wPlayerMovingDirection
wPlayerMovingDirection                         equ W_PLAYER_MOVING_DIRECTION
%endif
%ifndef wRivalStarter
wRivalStarter                                  equ W_RIVAL_STARTER
%endif
