...
;
; DEVIATION{class=HAL; pret=home/audio.asm:UpdateSound; behavior=precompiled tier-1 enhancement streams are played on FM voices the APU shim leaves unused, adding parts that do not exist in the Game Boy source data; evidence=the OPL3 has more voices than the GB has channels so the spare voices carry arrangement data generated by tools/audio into assets/enh_streams.inc, and the layer is disabled at runtime by the NOENH flag; lifetime=permanent, an opt-out enhancement layer by design}
;
