...
extern DisplayTitleScreen       ; src/engine/movie/title.asm — B on the menu returns to the title
...
; and the _NotEnoughMemoryText far stream. Generated by tools/generators/gen_menu_strings.py;
