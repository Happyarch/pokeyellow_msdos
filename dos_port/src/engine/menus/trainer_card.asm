...
;   Tiles are carried in assets/trainer_card_tiles.inc (tools/generators/gen_trainer_card_tiles.py,
...
; tools/generators/gen_menu_strings.py through the charmap (gb_text.encode). They were
