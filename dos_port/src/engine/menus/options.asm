...
; tools/generators/gen_menu_strings.py). They were hand-encoded charmap `db` bytes here until
...
; hand-encode charmap bytes"). They are now generated by tools/generators/gen_menu_strings.py
