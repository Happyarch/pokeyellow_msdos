...
extern CheckPikachuFollowingPlayer           ; home/pikachu.asm
...
; text_3.asm), flattened into assets/item_text.inc by tools/generators/gen_item_text.py.
...
; into assets/item_text.inc (tools/generators/gen_item_text.py) as {dd stream, dd length} pairs
...
; tools/generators/gen_menu_strings.py.
...
; assets/item_text.inc by tools/generators/gen_item_text.py — which already scans
