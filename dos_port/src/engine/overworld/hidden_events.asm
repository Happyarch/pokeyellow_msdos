...
W_HIDDEN_EVENT_FUNCTION_ARGUMENT equ 0xD88B ; wHiddenEventFunctionArgument (golden 00:cd3d)
%endif
%ifndef W_HIDDEN_EVENT_FUNCTION_ROM_BANK
W_HIDDEN_EVENT_FUNCTION_ROM_BANK equ 0xD88C ; wHiddenEventFunctionRomBank (golden 00:cd3e)
%endif
%ifndef W_HIDDEN_EVENT_INDEX
W_HIDDEN_EVENT_INDEX       equ 0xD88D   ; wHiddenEventIndex (golden 00:cd3f)
%endif
%ifndef W_HIDDEN_EVENT_Y
W_HIDDEN_EVENT_Y           equ 0xD88E   ; wHiddenEventY (golden 00:cd40)
%endif
%ifndef W_HIDDEN_EVENT_X
W_HIDDEN_EVENT_X           equ 0xD88F   ; wHiddenEventX (golden 00:cd41)
%endif
