...
extern IsToggleableHidden               ; src/engine/overworld/toggleable_objects.asm
...
; g_toggleable_flags MOVED 2026-08-22 to src/engine/overworld/toggleable_objects.asm,
; with the rest of the toggleable subsystem (pret's engine/overworld/toggleable_objects.asm).
...
; Both generated by tools/generators/gen_all_assets.py / gen_sprite_sets.py — do NOT hand-edit.
...
; Generated by tools/generators/gen_npc_dialogs.py — do NOT edit these files.
%include "assets/npc_dialogs/all_dialogs.inc"

; assets/toggleable_objects.inc MOVED 2026-08-22 to
; src/engine/overworld/toggleable_objects.asm, with the routines that read it.
...
; InitToggleableObjectFlags (now InitializeToggleableObjectsFlags) and
