...
extern ChangeBGPalColor0_4Frames        ; src/engine/gfx/screen_effects.asm
...
;
; Direct call, not a predef hop: the routine takes no argument — pret's own
; comment calls its opening GetPredefRegisters a red/blue leftover — which is
; the same convention as the AnyPartyAlive site below.
