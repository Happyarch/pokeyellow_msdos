; special_effect_pointers.asm — special-effect id -> effect routine.
;
; pret ref: data/battle_anims/special_effect_pointers.asm:SpecialEffectPointers
;
; pret keeps this table in data/ and %includes it INTO engine/battle/animations.asm.
; The port carries it at the mirrored path dos_port/src/data/battle_anims/special_effect_pointers.asm; it was part of
