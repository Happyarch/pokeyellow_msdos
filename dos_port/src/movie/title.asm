...
global ClearScreen
; SaveScreenTilesToBuffer2 / LoadScreenTilesFromBuffer2 moved to their pret
; mirror, src/home/tilemap.asm, together with the Buffer1 pair and the retired
; Title_* forked copies (menu-intro review 2026-07-23). This file now calls the
; canonical pret-named routines like every other screen.
...
extern GBPalWhiteOut                ; src/home/fade.asm — the real pret routine (retires Title_GBPalWhiteOut)
...
; Debug player/rival names: Tier-1 generated data, now %included by the pret
; mirror engine/movie/title.asm (menu-intro review 2026-07-23 — retires the
; movie/title.asm allowlist entries). Externed here for PrepareTitleScreen.
extern DebugNewGamePlayerName        ; src/engine/movie/title.asm (generated)
extern DebugNewGameRivalName         ; src/engine/movie/title.asm (generated)
...
; The Buffer1/Buffer2 save/load bodies and the Title_GBPalWhiteOut /
; Title_SaveScreenTilesToBuffer1 / Title_LoadScreenTilesFromBuffer1 forked
; copies that lived here are gone (menu-intro review 2026-07-23): the pret
; names now resolve to src/home/tilemap.asm (the pret mirror) and
; src/home/fade.asm, externed at the top of this file.

; CopyDebugName lives at its pret mirror, src/engine/movie/title.asm;
; Bank3D_CopyBox at src/engine/movie/title_yellow.asm (menu-intro review).
extern CopyDebugName                 ; src/engine/movie/title.asm
extern Bank3D_CopyBox                ; src/engine/movie/title_yellow.asm
