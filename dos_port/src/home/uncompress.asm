...
; Reference: docs/archive/translation_log.md (UncompressSpriteData entry — that
;            log is CLOSED as of 2026-08-21, verify against the tree),
;            docs/plans/battle_frontend.md (Stage 1c research).
;
