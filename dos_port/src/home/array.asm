; dos_port/home/array.asm — SkipFixedLengthTextEntries / AddNTimes.
; IsInArray is a pret home/array2.asm label and moved to that mirror,
; src/home/array2.asm, with its IsInRestOfArray twin.
bits 32
