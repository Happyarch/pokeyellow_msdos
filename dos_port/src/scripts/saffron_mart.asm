; SaffronMart.asm — translated from pret scripts/SaffronMart.asm by dos_port/tools/sm83xlat.
;
...
global SaffronMartCooltrainerFText
global SaffronMartSuperNerdText
...
SaffronMart_TextPointers:
    ...
    dd SaffronMartCooltrainerFText
