...
extern RocketHideout4TrainerHeader0          ; assets/trainer_headers.inc
extern RocketHideout4TrainerHeaders          ; assets/trainer_headers.inc
...
; Far text streams for this map — pret text/rocket_hideout_b_4f, generated by
