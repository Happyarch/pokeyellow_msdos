...
extern BrunoBeforeBattleText    ; assets/trainer_headers.inc
extern BrunosRoomTrainerHeader0 ; assets/trainer_headers.inc
extern BrunosRoomTrainerHeaders ; assets/trainer_headers.inc
