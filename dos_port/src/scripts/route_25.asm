...
; ---------------------------------------------------------------------------
; BAIL[owned-by-generated-assets] Route25_ScriptPointers (scripts/Route25.asm:49-88) — a generated asset already defines Route25TrainerHeaders
; NO SYMBOL IS DEFINED for this region. pret source follows, verbatim.
; ---------------------------------------------------------------------------
; PRET| 	def_script_pointers
; PRET| 	dw_const CheckFightingMapTrainers,              SCRIPT_ROUTE25_DEFAULT
; PRET| 	dw_const DisplayEnemyTrainerTextAndStartBattle, SCRIPT_ROUTE25_START_BATTLE
; PRET| 	dw_const EndTrainerBattle,                      SCRIPT_ROUTE25_END_BATTLE
; PRET| 
; PRET| Route25_TextPointers:
; PRET| 	def_text_pointers
; PRET| 	dw_const Route25Youngster1Text,    TEXT_ROUTE25_YOUNGSTER1
; PRET| 	dw_const Route25Youngster2Text,    TEXT_ROUTE25_YOUNGSTER2
; PRET| 	dw_const Route25CooltrainerMText,  TEXT_ROUTE25_COOLTRAINER_M
; PRET| 	dw_const Route25CooltrainerF1Text, TEXT_ROUTE25_COOLTRAINER_F1
; PRET| 	dw_const Route25Youngster3Text,    TEXT_ROUTE25_YOUNGSTER3
; PRET| 	dw_const Route25CooltrainerF2Text, TEXT_ROUTE25_COOLTRAINER_F2
; PRET| 	dw_const Route25Hiker1Text,        TEXT_ROUTE25_HIKER1
; PRET| 	dw_const Route25Hiker2Text,        TEXT_ROUTE25_HIKER2
; PRET| 	dw_const Route25Hiker3Text,        TEXT_ROUTE25_HIKER3
; PRET| 	dw_const PickUpItemText,           TEXT_ROUTE25_TM_SEISMIC_TOSS
; PRET| 	dw_const Route25BillSignText,      TEXT_ROUTE25_BILL_SIGN
; PRET| 
; PRET| Route25TrainerHeaders:
; PRET| 	def_trainers
; PRET| Route25TrainerHeader0:
; PRET| 	trainer EVENT_BEAT_ROUTE_25_TRAINER_0, 2, Route25Youngster1BattleText, Route25Youngster1EndBattleText, Route25Youngster1AfterBattleText
; PRET| Route25TrainerHeader1:
; PRET| 	trainer EVENT_BEAT_ROUTE_25_TRAINER_1, 3, Route25Youngster2BattleText, Route25Youngster2EndBattleText, Route25Youngster2AfterBattleText
; PRET| Route25TrainerHeader2:
; PRET| 	trainer EVENT_BEAT_ROUTE_25_TRAINER_2, 3, Route25CooltrainerMBattleText, Route25CooltrainerMEndBattleText, Route25CooltrainerMAfterBattleText
; PRET| Route25TrainerHeader3:
; PRET| 	trainer EVENT_BEAT_ROUTE_25_TRAINER_3, 2, Route25CooltrainerF1BattleText, Route25CooltrainerF1EndBattleText, Route25CooltrainerF1AfterBattleText
; PRET| Route25TrainerHeader4:
; PRET| 	trainer EVENT_BEAT_ROUTE_25_TRAINER_4, 4, Route25Youngster3BattleText, Route25Youngster3EndBattleText, Route25Youngster3AfterBattleText
; PRET| Route25TrainerHeader5:
; PRET| 	trainer EVENT_BEAT_ROUTE_25_TRAINER_5, 4, Route25CooltrainerF2BattleText, Route25CooltrainerF2EndBattleText, Route25CooltrainerF2AfterBattleText
; PRET| Route25TrainerHeader6:
; PRET| 	trainer EVENT_BEAT_ROUTE_25_TRAINER_6, 3, Route25Hiker1BattleText, Route25Hiker1EndBattleText, Route25Hiker1AfterBattleText
; PRET| Route25TrainerHeader7:
; PRET| 	trainer EVENT_BEAT_ROUTE_25_TRAINER_7, 2, Route25Hiker2BattleText, Route25Hiker2EndBattleText, Route25Hiker2AfterBattleText
; PRET| Route25TrainerHeader8:
; PRET| 	trainer EVENT_BEAT_ROUTE_25_TRAINER_8, 2, Route25Hiker3BattleText, Route25Hiker3EndBattleText, Route25Hiker3AfterBattleText
; PRET| 	db -1 ; end
...
; ---------------------------------------------------------------------------
; BAIL[owned-by-generated-assets] Route25Youngster1BattleText (scripts/Route25.asm:145-254) — a generated asset already defines Route25Youngster1BattleText
; NO SYMBOL IS DEFINED for this region. pret source follows, verbatim.
; ---------------------------------------------------------------------------
; PRET| 	text_far _Route25Youngster1BattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Youngster1EndBattleText:
; PRET| 	text_far _Route25Youngster1EndBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Youngster1AfterBattleText:
; PRET| 	text_far _Route25Youngster1AfterBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Youngster2BattleText:
; PRET| 	text_far _Route25Youngster2BattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Youngster2EndBattleText:
; PRET| 	text_far _Route25Youngster2EndBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Youngster2AfterBattleText:
; PRET| 	text_far _Route25Youngster2AfterBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25CooltrainerMBattleText:
; PRET| 	text_far _Route25CooltrainerMBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25CooltrainerMEndBattleText:
; PRET| 	text_far _Route25CooltrainerMEndBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25CooltrainerMAfterBattleText:
; PRET| 	text_far _Route25CooltrainerMAfterBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25CooltrainerF1BattleText:
; PRET| 	text_far _Route25CooltrainerF1BattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25CooltrainerF1EndBattleText:
; PRET| 	text_far _Route25CooltrainerF1EndBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25CooltrainerF1AfterBattleText:
; PRET| 	text_far _Route25CooltrainerF1AfterBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Youngster3BattleText:
; PRET| 	text_far _Route25Youngster3BattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Youngster3EndBattleText:
; PRET| 	text_far _Route25Youngster3EndBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Youngster3AfterBattleText:
; PRET| 	text_far _Route25Youngster3AfterBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25CooltrainerF2BattleText:
; PRET| 	text_far _Route25CooltrainerF2BattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25CooltrainerF2EndBattleText:
; PRET| 	text_far _Route25CooltrainerF2EndBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25CooltrainerF2AfterBattleText:
; PRET| 	text_far _Route25CooltrainerF2AfterBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Hiker1BattleText:
; PRET| 	text_far _Route25Hiker1BattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Hiker1EndBattleText:
; PRET| 	text_far _Route25Hiker1EndBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Hiker1AfterBattleText:
; PRET| 	text_far _Route25Hiker1AfterBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Hiker2BattleText:
; PRET| 	text_far _Route25Hiker2BattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Hiker2EndBattleText:
; PRET| 	text_far _Route25Hiker2EndBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Hiker2AfterBattleText:
; PRET| 	text_far _Route25Hiker2AfterBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Hiker3BattleText:
; PRET| 	text_far _Route25Hiker3BattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Hiker3EndBattleText:
; PRET| 	text_far _Route25Hiker3EndBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25Hiker3AfterBattleText:
; PRET| 	text_far _Route25Hiker3AfterBattleText
; PRET| 	text_end
; PRET| 
; PRET| Route25BillSignText:
; PRET| 	text_far _Route25BillSignText
; PRET| 	text_end
