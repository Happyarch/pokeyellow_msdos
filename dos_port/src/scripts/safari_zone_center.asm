; SafariZoneCenter.asm — translated from pret scripts/SafariZoneCenter.asm by dos_port/tools/sm83xlat.
;
...
global SafariZoneCenterRestHouseSignText
global SafariZoneCenterTrainerTipsSignText
...
SafariZoneCenter_TextPointers:
    dd PickUpItemText
    dd SafariZoneCenterRestHouseSignText
    dd SafariZoneCenterTrainerTipsSignText
