...
global SeafoamIslandsB2F_Script
...
SeafoamIslandsB2F_Script:
    ...
    jb .nr_9
        ret
.nr_9:
    mov esi, wEventFlags + EVENT_BYTE(EVENT_SEAFOAM3_BOULDER1_DOWN_HOLE)
    %assign event_byte EVENT_BYTE(EVENT_SEAFOAM3_BOULDER1_DOWN_HOLE)
    ...
    mov al, TOGGLE_SEAFOAM_ISLANDS_B3F_BOULDER_3
...
.boulder2FellDownHole:
    ...
    mov [ebp + wObjectToHide], al
    mov al, TOGGLE_SEAFOAM_ISLANDS_B3F_BOULDER_4
    mov [ebp + wObjectToShow], al
