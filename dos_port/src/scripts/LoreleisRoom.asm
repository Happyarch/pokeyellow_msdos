...
extern LoreleisRoomLoreleiBeforeBattleText ; assets/trainer_headers.inc
extern LoreleisRoomTrainerHeader0          ; assets/trainer_headers.inc
extern LoreleisRoomTrainerHeaders          ; assets/trainer_headers.inc
