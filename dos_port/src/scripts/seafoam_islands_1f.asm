...
global SeafoamIslands1F_Script
...
SeafoamIslands1F_Script:
    ...
    jb .nr_10
        ret
.nr_10:
    mov esi, wEventFlags + EVENT_BYTE(EVENT_SEAFOAM1_BOULDER1_DOWN_HOLE)
    %assign event_byte EVENT_BYTE(EVENT_SEAFOAM1_BOULDER1_DOWN_HOLE)
