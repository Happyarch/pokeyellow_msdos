; SafariZoneWestRestHouse.asm — translated from pret scripts/SafariZoneWestRestHouse.asm by dos_port/tools/sm83xlat.
;
...
global SafariZoneWestRestHouseCooltrainerMText
global SafariZoneWestRestHouseScientistText
global SafariZoneWestRestHouseSilphWorkerFText
...
SafariZoneWestRestHouse_TextPointers:
    dd SafariZoneWestRestHouseScientistText
    dd SafariZoneWestRestHouseCooltrainerMText
    dd SafariZoneWestRestHouseSilphWorkerFText
