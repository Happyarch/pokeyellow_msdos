; VermilionPidgeyHouse.asm — translated from pret scripts/VermilionPidgeyHouse.asm by dos_port/tools/sm83xlat.
;
...
global VermilionPidgeyHouseLetterText
global VermilionPidgeyHousePidgeyText
global VermilionPidgeyHouseYoungsterText
...
VermilionPidgeyHouse_TextPointers:
    ...
    dd VermilionPidgeyHouseLetterText
