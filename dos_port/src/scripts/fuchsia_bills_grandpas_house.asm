; FuchsiaBillsGrandpasHouse.asm — translated from pret scripts/FuchsiaBillsGrandpasHouse.asm by dos_port/tools/sm83xlat.
;
...
global FuchsiaBillsGrandpasHouseBillsGrandpaText
global FuchsiaBillsGrandpasHouseMiddleAgedWomanText
global FuchsiaBillsGrandpasHouseYoungsterText
...
FuchsiaBillsGrandpasHouse_TextPointers:
    ...
    dd FuchsiaBillsGrandpasHouseYoungsterText
