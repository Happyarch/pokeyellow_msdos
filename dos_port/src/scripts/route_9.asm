...
; ---------------------------------------------------------------------------
; Route9_ScriptPointers (scripts/Route9.asm:11-50) — Tier-1 data: Route9_ScriptPointers is generated into assets/map_script_tables.inc.
...
; ---------------------------------------------------------------------------
; Route9CooltrainerF1BattleText (scripts/Route9.asm:100-209) — Tier-1 data: Route9CooltrainerF1BattleText is generated into assets/trainer_headers.inc.
