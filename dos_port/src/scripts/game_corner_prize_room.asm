...
global GameCornerPRizeRoomPrizeVendorText
global GameCornerPrizeRoomBaldingGuyText
global GameCornerPrizeRoomGamblerText
...
GameCornerPrizeRoom_TextPointers:
    ...
    dd GameCornerPRizeRoomPrizeVendorText
    dd GameCornerPRizeRoomPrizeVendorText
    dd GameCornerPRizeRoomPrizeVendorText
