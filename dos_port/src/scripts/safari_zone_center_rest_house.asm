; SafariZoneCenterRestHouse.asm — translated from pret scripts/SafariZoneCenterRestHouse.asm by dos_port/tools/sm83xlat.
;
...
global SafariZoneCenterRestHouseGirlText
global SafariZoneCenterRestHouseScientistText
