...
extern RocketHideout2TrainerHeader0     ; assets/trainer_headers.inc
extern RocketHideout2TrainerHeaders     ; assets/trainer_headers.inc
extern RocketHideoutB2FRocketBattleText ; assets/trainer_headers.inc
