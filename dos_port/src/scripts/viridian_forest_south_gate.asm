; ViridianForestSouthGate.asm — translated from pret scripts/ViridianForestSouthGate.asm by dos_port/tools/sm83xlat.
;
...
global ViridianForestSouthGateGirlText
global ViridianForestSouthGateLittleGirlText
