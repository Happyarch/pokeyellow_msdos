; CeruleanMart.asm — translated from pret scripts/CeruleanMart.asm by dos_port/tools/sm83xlat.
;
...
global CeruleanMartCooltrainerFText
global CeruleanMartCooltrainerMText
global CeruleanMart_Script
...
CeruleanMart_TextPointers:
    ...
    dd CeruleanMartCooltrainerFText
